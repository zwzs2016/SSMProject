package com.bamboo.util.sensitivewdfilter;

import com.bamboo.util.sensitivewdfilter.util.BCConvert;
...
public class WordFilter {
	...
	private static void init() {
		// 获取敏感词
		addSensitiveWord(readWordFromFile("file/wd.txt"));
		addStopWord(readWordFromFile("file/stopwd.txt"));
	}
